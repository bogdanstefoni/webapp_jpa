...
public class LoggingFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,
		...
		logger.info("Starting..." + httpServletRequest.getMethod() + " " + httpServletRequest.getRequestURI()
				+ " at date: " + new Date());
		...
		logger.info("Finished..." + httpServletRequest.getMethod() + " " + httpServletRequest.getRequestURI()
